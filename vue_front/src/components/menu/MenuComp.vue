<template>
    <div class="menu-comp-container">
        ...
        @urlChange="$emit('urlChange', $event)"
        @authChange="$emit('authChange', $event)"
        @boardChange="$emit('boardChange', $event)"
        @useYnChange="$emit('useYnChange', $event)"
        @delMenu="$emit('delMenu', $event)"
                />
